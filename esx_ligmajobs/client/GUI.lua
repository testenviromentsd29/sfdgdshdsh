...
function GoldenMenu.Bool(option, bool, cb)
	GoldenMenu.Option(option)
...
function GoldenMenu.updateSelection()
	selectPressed = false;
	leftPressed = false;
	rightPressed = false;

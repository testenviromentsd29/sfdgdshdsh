...
Config = {
    ...
    DisarmPlayer = true,
    CancelEmoteKey = "X",
    OpenKey = 'F3', -- Default keybind to open menu (Players can change the key through fivem keybind settings)
...
Config.Languages = {
    ['en'] = { -- English 🇬🇧
        ['busmods'] = '~p~büŞ(SCAMMER) Emotes',
        ['emotes'] = 'Emote 🎬',
        ['danceemotes'] = "🕺 Dance Emotes",
        ['animalemotes'] = "🐩 Anomal Emotes",
        ['propemotes'] = "📦 Prop Emotes",
        ['favoriteemotes'] = "🌟 Favorites",
        ['favoriteinfo'] = "Select an emote to set as your favorite.",
        ...
        ['cancelemoteinfo'] = "X to Cancel Emote",
        ['walkingstyles'] = "Walking Style 🚶🏻‍♂️",
        ...
        ['notvaliddance'] = "Not a valid emote",
        ['notvalidemote'] = "Not a valid emote",
        ['nocancel'] = "No emote to cancel",
        ['maleonly'] = "This emote is male only, sorry!",
        ['emotemenucmd'] = "Use command /emotemenu_doit to open animations menu.",
        ['shareemotes'] = "👫 Shared Emotes",
        ['shareemotesinfo'] = "Invite a nearby person to share emote",
        ['sharedanceemotes'] = "🕺 Shared Dances",
        ['notvalidsharedemote'] = "is not a valid shared emote.",
        ['sentrequestto'] = "Shared emote invite shared",
        ['nobodyclose'] = "Nobody to invite",
        ['doyouwanna'] = "Y accept, L decline. (~g~",
    ...
    ['cs'] = { -- Czech 🇨🇿
        ...
        ['emotemenucmd'] = "Použíj /emotemenu_doit pro otevření menu.",
    ...
    ['fr'] = { -- French 🇫🇷
        ...
        ['emotemenucmd'] = "Fait /emotemenu_doit pour ouvrir le menu",
    ...
    ['de'] = { -- German 🇩🇪
        ...
        ['emotemenucmd'] = "Gebe den Befehl /emotemenu_doit ein, um das Menü zu öffnen",
    ...
    ['sv'] = { -- Swedish 🇸🇪
        ...
        ['emotemenucmd'] = "Använd /emotemenu_doit för att öppna animationsmenyn",
    ...
    ['es'] = { -- Spanish 🇪🇸
        ...
        ['emotemenucmd'] = "Escribe /emotemenu_doit para abrir el menu.",
    ...
    ['nl'] = { -- Dutch 🇳🇱
        ...
        ['emotemenucmd'] = "Doe /emotemenu_doit voor het animatiemenu.",
    ...
    ['pt'] = { -- Brazilian Portuguese 🇧🇷
        ...
        ['emotemenucmd'] = "Faça /emotemenu_doit para abrir o menu.",
    ...
    ['it'] = { -- Italian 🇮🇹
        ...
        ['emotemenucmd'] = "Esegui /emotemenu_doit per aprire il menù.",
    ...
    ['da'] = { -- Danish 🇩🇰
        ...
        ['emotemenucmd'] = "Skriv /emotemenu_doit for animationsmenuen",
    ...
    ['fi'] = { -- Finnish 🇫🇮
        ...
        ['emotemenucmd'] = "Käytä /emotemenu_doit avataksesi animaatio valikon",
    ...
    ['pl'] = { -- Polish 🇵🇱
        ...
        ['emotemenucmd'] = "Użyj komendy /emotemenu_doit by otworzyć menu animacji.",
    ...
    ['ro'] = { -- Romana 🇷🇴
        ...
        ['emotemenucmd'] = "Foloseste comanda /emotemenu_doit pentru a deschide meniul de animatii.",
        ['shareemotes'] = "👫 Shared Emotes",
